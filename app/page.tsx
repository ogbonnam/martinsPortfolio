...
export default function Home() {
  ...
  return (
    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <h1 className={`${inter.className} text-black text-6xl text-center font-extrabold`}>Let me Help You Build Your Next Modern Website. <strong className="text-color-blue-700">Easy Pissy!!! </strong></h1>
      <p className={`${roboto.className} w-4/5 pt-5 text-xl font-bold text-center`}>I can bring your next big idea to life using code. I love playing with code, designing your frontend using modern technology, building the backend and its database and automating and deploying your product using DevOps pipeline.</p>
