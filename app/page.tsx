...
export default function Home() {
  ...
  return (
    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <h1 className={`${inter.className} text-6xl text-center font-extrabold`}>Let me Help You Build Your Next Modern Website. <strong className="text-color-blue-700">Easy Pissy! </strong></h1>
